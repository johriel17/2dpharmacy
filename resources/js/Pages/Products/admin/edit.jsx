...
export default function Edit({ auth, product }) {
    ...
    function submit(e) {
        ...
        // router.post(`/admin-products/update/${user.id}`, {
        //     _method: 'put',
        //     data: data,
        //   })
    }
                        ...
                        <div className="flex justify-center m-10 px-10">
                            <form className="w-full mx-auto" onSubmit={submit}>
                                ...
                                <div className="mb-5">
                                    ...
                                    {/* {product.image && (
                                        <img src={`/storage/imgs/products/${product.id}/${product.image}`} alt="Current Product" className="block w-32 h-32 mb-2" />
                                    )} */}
                                ...
                                <div className="flex justify-end items-center gap-4">
                                    ...
                                    <button type="submit" disabled={processing} className="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
